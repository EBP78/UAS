...
<?php
    ...
    if(isset($_POST['submit'])){
        if(empty($_POST['provinsi'])){
            ...
            mysqli_query($connection, "insert into kabupaten values ('$id ', '$nama', $luas, '$provinsi');");
            header("location:kabupaten.php");
        }            
    }
    $kosong = '';
...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>EBP - BackEnd - Table Kabupaten</title>
                ...
                <div class="container">
                    ...
                    <div class="card">
                        <div class="card-content">
                            <h4 class="card-title">
                                Input ke Tabel kabupaten Database A_wisata
                            </h4>
                    ...
                    <div id="validation" class="card card card-default scrollspy">
                        <div class="card-content">
                            <h4 class="card-title">Form input Kabupaten</h4>
                            <form method="POST">
                                <div class="row">
                    ...
                    ?>
                        ...
                        <div id="modal<?php
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="delete_kabupaten.php?delete=<?php
                                    echo $row['kabupatenid'];
