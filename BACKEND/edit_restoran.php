...
<?php
    ...
    $get = "select restorannama, restorandeskripsi, restoranharga, restoranrating, kecamatanid from restoran
    where restoranid = '$editID';";
    ...
    if(isset($_POST['submit'])){
        if(empty($_POST['harga'])){
            echo '<script type="text/javascript">
                window.location.assign("restoran.php");
            </script>';
        } elseif ($_POST['nama'] == ""){
...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>EBP - BackEnd - Table Restoran</title>
                ...
                <div class="container">
                    ...
                    <div class="card">
                        <div class="card-content">
                            <h4 class="card-title">
                                Input ke Tabel Restoran Database A_wisata
                            </h4>
                            <p>dapat langsung melakukan input ke tabel a_wisata.Restoran dengan menggunakan form dibawah ini</p>
                        </div>
                    </div>
                            ...
                            <form method="POST">
                                <div class="row">
                                    <div class="input-field col s12">
                                        ...
                                        <input id="kode" type="text" name="kode" class="validate" value="<?php
                                            echo $editID;
                                        ?>" disabled>
                                        <label for="kode">Restoran ID</label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="input-field col s12">
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        ...
                                        <textarea id="deskripsi" name="deskripsi" class="materialize-textarea validate"><?php
                                            echo $get_data['restorandeskripsi'];
                                        ?></textarea>
                                        <label for="deskripsi">Deskripsi Restoran</label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="input-field col s12">
                                        <i class="material-icons prefix">attach_money</i>
                                        <input id="harga" type="text" name="harga" class="validate" value="<?php
                                            echo $get_data['restoranharga'];
                                        ?>">
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        <span>Rating</span>
                                        <p class="range-field">
                                            <input type="range" id="test5" min="0" max="5" name="rating" value="<?php
                                            echo $get_data['restoranrating'];
                                        ?>">
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        ...
                                        <select class="select2 browser-default validate" name="kecamatan" id="kecamatan">
                                            <?php
                                                $kategori = mysqli_query($connection, "select kecamatanid, kecamatannama
                                                from kecamatan;");
                    ...
                    <div class="card">
                        <div class="card-content">
                            <h4 class="card-title">
                                Output Tabel Restoran dari Database A_wisata
                            </h4>
                            <p>output dari tabel a_wisata.restoran dalam bentuk tabel dan juga bisa langsung melakukan edit dan hapus data dari tabel dibawah ini.</p>
                        </div>
                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="row">
                                        ...
                                        <table id="page-length-option" class="display">
                                            ...
                                            <tbody>
                                                <?php
                                                    $query = mysqli_query($connection, "select r.restoranid, r.restorannama, r.restorandeskripsi, r.restoranharga, r.restoranrating, k.kecamatannama
                                                    from restoran r, kecamatan k
                                                ...
                                                <tr>
                                                    ...
                                                    ?></td>
                                                    <td><?php
                                                        echo $row['restorandeskripsi'];
                                                    ?></td>
                                                    <td><?php
                                                        echo $row['restoranharga'];
                                                    ?></td>
                                                    <td><?php
                                                        echo $row['restoranrating'];
                                                    ?></td>
                                                    <td><?php
...
?>
    ...
    <script>
        $(document).ready(function(){
            $('#kecamatan').select2({
                placeholder: "Kecamatan Restoran",
                allowClear: true
            });
        });
    </script>
