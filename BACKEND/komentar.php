...
<?php
    ...
    if(isset($_POST['submit'])){
        if(empty($_POST['nama'])){
            ...
            mysqli_query($connection, "insert into komentar values (null, '$nama', '$email', '$content');");
                            ...
                            <form method="POST">
                                <div class="row">
                                    <div class="input-field col s12">
                                        ...
                                        <input id="kode" type="text" name="kode" class="validate" value="auto increment" disabled>
                                        ...
                                        <table id="page-length-option" class="display">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    ?></td>
                                                    <td>
                                                        <a href="edit_komentar.php?edit=<?php
                                                        echo $row['komentarid'];
                    ...
                    ?>
                        ...
                        <div id="modal<?php
                            ...
                            <div class="modal-content">
                                ...
                                <h6>Apakah anda yakin ingin menghapus data Komentar </h6>
                                <table>
                                    <thead>
                                        <tr>
                                            <th>komentar ID</th>
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="delete.php?delete=<?php
                                    echo $row['komentarid'];
                                ?>&table=komentar" class="modal-close waves-effect waves-green btn-flat">Ya</a>
                            </div>
                        </div>
                    <?php
                        }
