...
<?php
    ...
    if(isset($_POST['submit'])){
        if(empty($_POST['kode'])){
            ...
            mysqli_query($connection, "insert into provinsi values ('$provinsiid ', '$provinsinama', '$tanggalberdiri');");
...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>EBP - BackEnd - Table Provinsi</title>
                                        ...
                                        <table id="page-length-option" class="display">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    ?></td>
                                                    <td>
                                                        <a href="edit_provinsi.php?edit=<?php
                                                        echo $row['provinsiID'];
