...
<?php
    ...
    if(isset($_POST['submit'])){
        if(empty($_POST['harga'])){
            ...
            mysqli_query($connection, "insert into restoran values ('$kode ', '$nama', '$deskripsi', '$harga', $rating, '$kecamatan');");
                            ...
                            <form method="POST">
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        ...
                                        <textarea id="deskripsi" name="deskripsi" class="materialize-textarea validate"></textarea>
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        <span>Rating</span>
                                        <p class="range-field">
                                            <input type="range" id="test5" min="0" max="5" name="rating">
                                        </p>
                                    </div>
                                </div>
                                <?php
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        ...
                                        <select class="select2 browser-default validate" name="kecamatan" id="kecamatan">
                                            <option value=""></option>
                                            <?php
                                                while($get_kat = mysqli_fetch_array($kec)){
                                            ?>
                                            <option value="<?php
                                                echo $get_kat['kecamatanid'];
                                            ?>"><?php
                                            echo $get_kat['kecamatanid'] . " " . $get_kat['kecamatannama'];
                                            ?></option>
                                            <?php
                                                }
                                            ?>
                                        ...
                                        <table id="page-length-option" class="display">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    ?></td>
                                                    <td>
                                                        <a href="edit_restoran.php?edit=<?php
                                                        echo $row['restoranid'];
                    ...
                    ?>
                        ...
                        <div id="modal<?php
                            ...
                            <div class="modal-content">
                                ...
                                <h6>Apakah anda yakin ingin menghapus data Restoran </h6>
                                <table>
                                    <thead>
                                        <tr>
                                            <th>Restoran ID</th>
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="delete.php?delete=<?php
                                    echo $row['restoranid'];
                                ?>&table=restoran" class="modal-close waves-effect waves-green btn-flat">Ya</a>
                            </div>
                        </div>
                    <?php
                        }
