...
<?php
    ...
    include "includes/config.php";
     ...
     $get = "select provinsiid,provinsinama,date_format(provinsiTglBerdiri,'%d/%c/%Y') as provinsiTglBerdiri
     from provinsi
     where provinsiid = '$editID';";
    ...
    if(isset($_POST['submit'])){
        if(empty($_POST['kode'])){
            echo '<script type="text/javascript">
                window.location.assign("provinsi.php");
            </script>';
        } elseif ($_POST['nama'] == ""){
            header("location:provinsi.php");
        } else {
            $provinsiid = $_POST['kode'];
            $provinsinama = $_POST['nama'];
            $tanggalberdiri = date('Y-m-d', strtotime(strtr($_POST['tanggal'], '/', '-')));
            
            mysqli_query($connection, "update provinsi set
            provinsinama = '$provinsinama',
            provinsitglberdiri = '$tanggalberdiri'
            where provinsiid = '$editID';");
...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>EBP - BackEnd - Edit Table Provinsi</title>
                ...
                <div class="container">
                    ...
                    <div class="card">
                        <div class="card-content">
                            ...
                            <p>dapat langsung melakukan input ke tabel a_wisata.provinsi dengan menggunakan form dibawah ini</p>
                        </div>
                    </div>

                    <div id="validation" class="card card card-default scrollspy">
                        <div class="card-content">
                            <h4 class="card-title">Form Input Tabel Provinsi</h4>
                            <form method="POST">
                                <div class="row">
                                    <div class="input-field col s12">
                                        ...
                                        <input id="kode" type="text" name="kode" class="validate" value="<?php
                                            echo $editID;
                                        ?>">
                                        <label for="kode">Provinsi ID</label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="input-field col s12">
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        ...
                                        <input id="tanggal" type="text" name="tanggal" class="datepicker validate" value="<?php
                                            echo $get_data['provinsiTglBerdiri'];
                                        ?>">
                    ...
                    <div class="card">
                        <div class="card-content">
                            <h4 class="card-title">
                                Output Tabel Provinsi dari Database A_wisata
                            </h4>
                            <p>output dari tabel a_wisata.Provinsi dalam bentuk tabel dan juga bisa langsung melakukan edit dan hapus data dari tabel dibawah ini.</p>
                        </div>
                    </div>
                                        ...
                                        <table id="page-length-option" class="display">
                                            <thead>
                                                <tr>
                                                    <th>Provinsi ID</th>
                                                    <th>Nama Provinsi</th>
                                                    <th>Tanggal Provinsi Berdiri</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                                                    $query = mysqli_query($connection, "select provinsiID,provinsiNama,date_format(provinsiTglBerdiri,'%d-%b-%Y') as provinsiTglBerdiri
                                                    from provinsi
                                                    order by provinsiid;");
                    ...
                    ?>
                        ...
                        <div id="modal<?php
                            ...
                            <div class="modal-content">
                                ...
                                <h6>Apakah anda yakin ingin menghapus data Provinsi </h6>
                                <table>
                                    <thead>
                                        <tr>
                                            <th>Provinsi ID</th>
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="delete_provinsi.php?delete=<?php
                                    echo $row['provinsiID'];
