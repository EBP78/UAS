    ...
    if(isset($_POST['submit'])){
        if(empty($_POST['nama'])){
            ...
            if ($file_extension == "jpg" or $file_extension == "png" or $file_extension == "jpeg" or $file_extension == "jfif" or $file_extension == "webp"){
                ...
                values ('$imgaeID','$ImageName','$destinasiID','$file_name');";
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        ...
                                        <select class="select2 browser-default validate" name="destinasi" id="destinasi">
                                            <option value=""></option>
                                            <?php
                                                while($get_des = mysqli_fetch_array($des)){
                                            ?>
                                            <option value="<?php
                                                echo $get_des['destinasiid'];
                                            ?>"><?php
                                            echo $get_des['destinasiid'] . " " . $get_des['destinasinama'];
                                            ?></option>
                                            <?php
                                                }
                                            ?>
                                        ...
                                        <table id="page-length-option" class="display">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="edit_image_destinasi.php?edit=<?php
                                                        echo $row['imageid'];
                    ...
                    ?>
                        ...
                        <div id="modal<?php
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="delete_image_destinasi.php?delete=<?php
                                    echo $row['imageid'];
