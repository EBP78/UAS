      ...
      <div class="row">
         <div class="col-lg-8 offset-lg-2">
            <div class="page-titles whitecolor text-center padding_top padding_bottom">
               ...
               <h2 class="font-bold">Pesawat Terbaik</h2>
      ...
      <div class="gradient-bg title-wrap">
         <div class="row">
            <div class="col-lg-12 col-md-12 whitecolor">
               <h3 class="float-left">Pesawat</h3>
               <ul class="breadcrumb top10 bottom10 float-right">
                  <li class="breadcrumb-item hover-light"><a href="index.php">Home</a></li>
                  <li class="breadcrumb-item hover-light">Pesawat</li>
               </ul>
            </div>
         </div>
      </div>
   ...
   <div class="container">
      <div class="row">
         <div class="col-md-12 text-center wow fadeIn" data-wow-delay="300ms">
            <h2 class="heading bottom30 darkcolor font-light2">Best <span class="font-normal">Airplane</span>
         ...
         <?php
            $get = 0 + ($page * 3);
            $query = "select p.pesawatnama, p.jampenerbangan, p.lamapenerbangan, p.biaya, pr1.provinsinama as asal, pr2.provinsinama as tujuan
            from pesawat p, provinsi pr1, provinsi pr2
            where p.provinsiasal = pr1.provinsiid
            and p.provinsitujuan = pr2.provinsiid
            limit $get,3;";
         ...
         ?>
            <div class="col-lg-4 col-md-6 col-sm-6 wow fadeIn" data-wow-delay="300ms">
                ...
                <div class="image sale" data-sale="30">
                    <img src="app-assets/images/pesawat.jpg" alt="pesawat">
                    <div class="overlay overlay-blue center-block">
                        <a class="opens" href="#" title="Add To Cart" target="_blank"><i class="fa fa-plane"></i></a>
                    </div>
                </div>
                <div class="shop-content text-center">
                    <h4 class="darkcolor pb-2"><a href="#" target="_blank"><?php
                        echo $data['pesawatnama'];
                    ?></a></h4>
                    <p><?php
                    ...
                    <ul style="list-style: disc;" class="pl-3">
                        <li>
                            <p class="my-1"><span>Jam Penerbangan : </span><span class="font-light"><?php
                                echo $data['jampenerbangan'];
                            ?></span></p>
                        </li>
                        <li>
                            <p class="my-1 bottom10"><span>Lama Penerbangan : </span><span class="font-light"><?php
                                echo $data['lamapenerbangan'];
                            ?></span></p>
                        </li>
                    </ul>
