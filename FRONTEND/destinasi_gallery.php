        ...
        <div class="gradient-bg title-wrap mt-n5">
            <div class="row">
                <div class="col-lg-12 col-md-12 whitecolor">
                    <h3 class="float-left">Destination_gallery</h3>
    ...
    <div class="container">
        <div class="col-md-12 text-center heading_space wow fadeIn" data-wow-delay="300ms">
            ...
            <div class="col-md-8 offset-md-2">
                <p class="mb-n3">silahkan memilih news destinasi yang bisa dibuka per provinsi dengan memilih tab</p>
            </div>
        </div>
        ...
        <div id="services-measonry" class="cbp">
            <?php
                $query = "select d.destinasiid, d.destinasialamat, d.destinasinama, p.provinsinama, i.file
                from destinasi d, provinsi p, image i, area a
